export const ReasonAr: string[] = [
  ...
  "السفر لأسباب عائلية قاهرة ، لمساعدة الأشخاص الضعفاء أو رعاية الأطفال.",

  "رحلات قصيرة ، في حدود ساعة واحدة يوميًا وضمن قطر بحد أقصى كيلومتر واحد حول المنزل ، مرتبطة إما بالنشاط البدني الفردي للناس، مع استبعاد أي ممارسة رياضية جماعية وأي قرب من الأشخاص الآخرين ، إما المشي مع الأشخاص الوحيدين في نفس المنزل ، أواحتياجات الحيوانات الأليفة.",

  "استدعاء قضائي أو إداري.",

  "المشاركة في مهمات المصلحة العامة بناء على طلب الهيئة الإدارية."
];

export const ReasonFr: string[] = [
